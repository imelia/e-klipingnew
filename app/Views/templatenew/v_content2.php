  ...
  <?php foreach ($user as $h) : ?>
   <div class="middle clearfix">
    <div class="col-sm-12">
     ...
     <a href="#"> <embed src="<?php echo base_url() ?>/assets/pdf/berita/<?= $h['gambar_berita']; ?>" width="100%" height="800px" alt="" class="img-fluid">
...
<section id="news_data">
 <div class="container">
  <div class="row">
	...
	<div class="col-sm-3">
	  <div class="news_data_right clearfix">
...
<section id="center_last">
 <div class="container">
  <div class="row">
   <div class="center_last_left col-sm-12">
	   <h2><a href="detail.html"><i class=""></i></a></h2>
	  </div>
